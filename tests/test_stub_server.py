...
from ksef.stub_server import clear_storage, create_app
...
class TestStubServer:
    ...
    def test_generate_token_success(self):
        ...
        request_data = {"nip": "1234567890", "environment": "test"}
    ...
    def test_generate_token_invalid_environment(self):
        ...
        request_data = {"nip": "1234567890", "environment": "invalid"}
    ...
    def test_send_invoice_success(self):
        ...
        token_response = self.client.post(
            "/v1/auth/token", json={"nip": "1234567890", "environment": "test"}
        )
    ...
    def test_send_invoice_invalid_xml(self):
        ...
        invoice_data = {"xml_content": "not xml content", "filename": "test.xml"}
