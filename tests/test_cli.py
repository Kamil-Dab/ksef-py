...
class TestCLI:
    ...
    def test_send_command_success(self, mock_client_class):
        ...
        try:
            result = self.runner.invoke(main, ["send", tmp_path, "--nip", "1234567890"])
        finally:
            # Clean up temp file
            import os
    ...
    def test_status_command_success(self, mock_client_class):
        ...
        result = self.runner.invoke(
            main, ["status", "KSEF:2025:PL/123/ABC", "--nip", "1234567890"]
        )
    ...
    def test_download_command_success(self, mock_client_class):
        ...
        result = self.runner.invoke(
            main, ["download", "KSEF:2025:PL/123/ABC", "--nip", "1234567890"]
        )
    ...
    def test_validate_command_success(self):
        ...
        with patch("xml.etree.ElementTree.parse") as mock_parse:
            ...
            try:
                result = self.runner.invoke(main, ["validate", tmp_path])
            finally:
                # Clean up temp file
                import os
